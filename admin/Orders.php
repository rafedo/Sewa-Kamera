      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        <div class="container-fluid">
          <div class="row p-5">
            ...
            function tambah($koneksi)
            {
              ...
              if (isset($_POST['btn_simpan'])) {
                ...
                if (!empty($Fname) && !empty($address) && !empty($telp) && !empty($email)) {
                  $sql = "INSERT INTO users (id,Fnama,Lnama, address, telp, email) VALUES(" . $id . ",'" . $Fname . "','" . $Lname . "','" . $address . "','" . $telp . "','" . $email . "')";
          ...
          <?php
            ...
            {
              $sql = "SELECT  peminjaman.id, users.Fname, users.Lname,produk.nama_barang, peminjaman.tanggal_peminjaman, peminjaman.tanggal_pengembalian,peminjaman.jumlah_hari,peminjaman.total_harga,peminjaman.status  
              FROM peminjaman 
              INNER JOIN users ON users.id = peminjaman.id_user 
              INNER JOIN produk ON produk.id = peminjaman.id_barang ";
              ...
              <div class="col">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="" method="POST">
                      <div class="form-group">
                        <label for="Lname">Nama Depan</label>
